    ...
    return (
      <div className=''>
          ...
          <form onSubmit={onSubmit}>
            ...
            <input ref={emailRef} className='mb-3 rounded border w-[80%] border-gray-400 h-[30px] pl-2' type='email'></input><br/>
            
            <label className='font-semibold'>Contraseña</label> <br/>
            <input ref={passwordRef} className='mb-3 rounded border w-[80%] border-gray-400 h-[30px] pl-2' type='password'></input> <br/>
